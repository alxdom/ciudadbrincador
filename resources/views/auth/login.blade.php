@extends('layouts.app', ['class' => 'login-page', 'page' => __('Inicio'), 'contentClass' => 'login-page'])

@section('content')
    <div class="col-md-10 text-center ml-auto mr-auto">
        <h3 class="mb-5">Inicia sesión y chinga a tu madre en colores neón</h3>
    </div>
        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-footer">
                    ...
                    <div class="pull-left">
                        <h6>
                            <a href="{{ route('register') }}" class="link footer-link">{{ __('Crear una cuenta') }}</a>
                        </h6>
                    </div>
