@extends('layouts.app', ['page' => __('Home Profile'), 'pageSlug' => 'profile'])
                ...
                <div class="card-body">
                    <p class="card-text">
                        <div class="author">
                            ...
                            <a href="#">
                                <img class="avatar" src="https://pbs.twimg.com/profile_images/967936990170632192/DpHM39E9_400x400.jpg" alt="">
                    ...
                    <div class="card-description">
                        {{ __('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna 
